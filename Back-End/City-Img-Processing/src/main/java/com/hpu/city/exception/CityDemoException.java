package com.hpu.city.exception;
 ...
 */
@ControllerAdvice
public class CityDemoException {

	private static final Logger logger = LoggerFactory.getLogger(CityDemoException.class);
	...
	public ResponseEntity<Object> exception(DataNotFoundException exception) {
		...
		return new ResponseEntity<>(ApplicationConstants.NOT_FOUND_ERROR_MSG, HttpStatus.NOT_FOUND);
	}
